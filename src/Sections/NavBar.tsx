...
const scroll = function (offset:number, id:string) {
...
export function checkScrollDown() {
    const line:any = document.getElementById('loadline')
    const limit:number = Math.max(document.body.scrollHeight, document.body.offsetHeight, document.documentElement.clientHeight, document.documentElement.scrollHeight, document.documentElement.offsetHeight);
    ...
    if (window.scrollY > 50) {
        const scrollElement:any = document.getElementById('scrollAnimation')
